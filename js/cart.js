...
async function fetchCurrencies() {
    try {
        const response = await fetch(`${API_BASE}menu/get_currencies.php`);
...
async function fetchBranches() {
    try {
        const response = await fetch(`${API_BASE}admin/get_branches.php`, {
            credentials: 'include'
        });
        const result = await response.json();
...
async function placeOrder() {
    ...
    try {
        ...
        // Create order
        const response = await fetch(`${API_BASE}orders/create_order.php`, {
            method: 'POST',
            headers: {
