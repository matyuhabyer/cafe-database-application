...
public class ManageMenuServlet extends HttpServlet {
    ...
    private void createMenuItem(Connection conn, JsonObject input, HttpServletResponse response) 
        ...
        // Insert menu item
        String insertQuery = "INSERT INTO Menu (category_id, name, description, price_amount, is_drink, is_available) " +
                           "VALUES (?, ?, ?, ?, ?, ?)";
        int menuId;
        try (PreparedStatement stmt = conn.prepareStatement(insertQuery, Statement.RETURN_GENERATED_KEYS)) {
            ...
            stmt.setDouble(4, priceAmount);
            stmt.setBoolean(5, isDrink);
