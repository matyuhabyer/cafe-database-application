...
public class GetMenuServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        System.out.println("========================================");
        System.out.println("📋 GetMenuServlet: Fetching menu from MySQL database");
        System.out.println("Currency: " + currencyCode);
        System.out.println("========================================");
        
        Connection conn = DatabaseConfig.getDBConnection();
        if (conn == null) {
            System.err.println("❌ Database connection failed - cannot fetch menu");
        ...
        try {
            ...
            System.out.println("Querying categories from database...");
            ...
            System.out.println("SQL: " + menuQuery);
            int menuItemCount = 0;
            try (Statement stmt = conn.createStatement();
                ...
                System.out.println("✅ Found " + menuItemCount + " menu items in database");
            }
            ...
            System.out.println("✅ Total menu items to return: " + totalItems);
            System.out.println("✅ Sending menu data to client");
            System.out.println("========================================");
